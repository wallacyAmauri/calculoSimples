...
<body>
    ...
    function aliquota1($v,$a,$array) {
        //var_dump($array);
        $temp = null;
        if($v <= 180000){
            $temp = "a";
        }else if($v>  180000  && $v <= 360000){
            $temp = "b";
        }else if($v>  360000  && $v <= 720000){
            $temp = "c";
        }else if($v>  720000  && $v <= 1800000){
            $temp = "d";
        }else if($v>  1800000  && $v <= 3600000){
            $temp = "e";
        }else if($v>  3600000  && $v <= 4800000){
            $temp = "f";
        }
        echo($array[$temp][$a]["IRPJ"]);   
    }
    $array = [    
        "a"=>[
            1=>[
